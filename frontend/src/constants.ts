...
export const CATEGORIES: CategoryMeta[] = [
  {
    ...
    fields: [
      { key: 'preset', label: 'Base Preset', type: 'select', description: 'symbol-bootstrap のベーステンプレート', options: [{ value: 'bootstrap', label: 'bootstrap (PQC custom network)' }], editableOnPublicNetwork: true },
...
// PQC edition: official mainnet/testnet preset overrides removed — the PQC
// launcher cannot create or join official Symbol networks.
  bootstrap: {
